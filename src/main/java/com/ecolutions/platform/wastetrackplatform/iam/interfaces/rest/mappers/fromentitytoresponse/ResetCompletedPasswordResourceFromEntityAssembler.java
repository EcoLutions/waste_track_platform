...
public class ResetCompletedPasswordResourceFromEntityAssembler {
    public static ResetCompletedPasswordResource toResourceFromEntity(User entity) {
        return ResetCompletedPasswordResource.builder()
                .userId(entity.getId())
